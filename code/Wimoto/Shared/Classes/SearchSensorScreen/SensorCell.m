...
- (void)setSensor:(Sensor *)sensor {
    [_sensor removeObserver:self forKeyPath:OBSERVER_KEY_PATH_SENSOR_VALUE];
    ...
    [_sensor addObserver:self forKeyPath:OBSERVER_KEY_PATH_SENSOR_VALUE options:NSKeyValueObservingOptionNew context:NULL];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
    ...
    if ([keyPath isEqualToString:OBSERVER_KEY_PATH_SENSOR_VALUE]) {
        _valueLabel.text = [NSString stringWithFormat:@"%@", [change objectForKey:NSKeyValueChangeNewKey]];
